...
public class Server {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        File databaseFile = new File("data/database.db");
        System.out.println("Conectando a: " + databaseFile.getAbsolutePath());

        try (Connection conn = DriverManager.getConnection("jdbc:sqlite:" + databaseFile.getAbsolutePath())) {// Try con recursos para cerrar automáticamente la conexión
